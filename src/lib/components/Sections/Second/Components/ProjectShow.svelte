...
>
	...
	>
		<div class="w-full h-full flex items-center flex-col">
			...
			<div
				class="h-0.5 bg-zinc-800 text-slate-100 dark:bg-slate-50 w-60 lg:w-80 mt-4 dark:text-zinc-800"
			></div>

			<div class="flex flex-col items-center w-[90%] p-2 mt-5 overflow-y-auto">
				...
				<p
					class="mt-10 texta-zinc-800 dark:text-white w-[90%] lg:w-2/3 text-lg lg:text-2xl text-justify"
				>
					{project.description}
				</p>
				...
				<div class="flex flex-col items-center h-full justify-center mb-10">
