...
<div transition:scale={{ duration: 400, delay: 10, opacity: 0.0, start: 0.2 , easing: quintOut }} class=" w-full h-full flex flex-col lg:flex-row items-center z-50 ">
    <div class="  w-full lg:w-1/2 scale-75 shadow-2xl">
        <img alt="me" class="rounded-lg w-full h-full" src="icons/me.png"/>
    </div> 
    <div class="lg:w-1/2 w-full  scale-90 -mt-10">
        <p class="text-zinc-800 bg-slate-100 dark:text-slate-100 dark:bg-zinc-800 mt-2 shadow-xl text-md lg:text-2xl p-4 lg:p-10 w-full rounded-lg">
        ...
        <p class=" dark:text-slate-100 dark:bg-zinc-800 bg-slate-100 shadow-xl text-md lg:text-2xl p-4 lg:p-10 w-full rounded-lg ">
            I am interested in Front-End web development and 3D graphics programming with C++ and OpenGL
        </p>
    </div>
</div>
{/if}